---
description: Sage Docs — create or update a styled HTML doc (English by default, shared CSS/JS) with 80vh diagrams, TL;DR, clickable nodes, top-to-bottom narrative
alwaysApply: false
---
