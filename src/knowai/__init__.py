...
def _load_config() -> None:
    ...
    overwrite an already-set value):
        ...
        2. ./knowai.config — walks up from cwd to find a project-local file
        3. ~/.knowai.config — user-global fallback
    ...
    # 1. Walk up from cwd looking for project-local knowai.config
    cwd = Path.cwd()
    ...
    # 2. User-global fallback at ~/.knowai.config
