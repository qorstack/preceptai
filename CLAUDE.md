...
Precept is a **cognition protocol** for AI coding agents, shipped as a single
...
- **`agents/preceptai/`** — starter cognition knowledge as Markdown (YAML
...
- **`landing/`** — the static promo site (dark, deployed to GitHub Pages /
  `preceptai.qorstack.com`). Edit `landing/index.html`.
