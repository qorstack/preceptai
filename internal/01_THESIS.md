...
ทุก feature ทุก decision ต้องสอบผ่าน 2 ประโยคนี้ — ถ้าไม่ผ่านคือไม่ใช่ Precept
...
Precept แก้ทั้ง 3 ด้วยการ **บังคับ AI ให้ call MCP tools ก่อน** ไม่ใช่หวังว่า AI จะอ่าน markdown (ซึ่งหลักฐานชี้ว่า AI ignore บ่อย)
...
→ Precept ให้ intuition นี้แบบ structured ผ่าน MCP tools
...
| **Precept**                   | **Enforced cognition pipeline** (memory + reasoning + impact + risk + workflow) |

ตลาดส่วนใหญ่ solve "memory"
Precept solve **"cognition + enforcement"** — ยังไม่มีใครทำดีจริง

## Real-world usage

**Scenario:** Dev บอก AI "add password reset flow"

| Without Precept                              | With Precept                                                                |
| -------------------------------------------- | --------------------------------------------------------------------------- |
